Pod::Spec.new do |s|
  ...
  s.dependency 'Register'
  s.dependency 'TabBar'
  s.dependency 'AppNetwork'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = ['LogIn/Classes/**/*.{h,m,swift,json,csv,strings,xib,storyboard, xcassets, xcdatamodeld}']
  
  s.resource_bundles = {
      'LogIn' => ['LogIn/**/*.{xcdatamodeld,csv}']
  }
